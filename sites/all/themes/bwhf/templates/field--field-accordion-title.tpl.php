...
<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="field-items"<?php print $content_attributes; ?>>
    <?php foreach ($items as $delta => $item): ?>
      <h2 class="field-item <?php print $delta % 2 ? 'odd' : 'even'; ?>"<?php print $item_attributes[$delta]; ?>>
        <a href="#">
          <?php print render($item); ?>
          <span class="accordion-toggle accordion-toggle--expand"><?php print t('Click to Expand');?></span>
          <span class="accordion-toggle accordion-toggle--collapse"><?php print t('Click to Collapse');?></span>
        </a>
      </h2>
    <?php endforeach; ?>
  </div>
